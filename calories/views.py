...
#Home page view all food and calorie detalis
...
#Registration page to SignUP new users
...
#View to select food for a particular day
...
#View to delete Food given by the particular user
@login_required
...
#pView to display details of the user
